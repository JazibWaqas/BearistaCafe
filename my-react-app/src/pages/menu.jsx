...
const Menu = () => {
  ...
  // Function to open the modal with selected drink
  const openModal = (event) => {
    const drinkBox = event.currentTarget.closest(".box");
    let imagePath = drinkBox.getAttribute("data-image");
  
    // Ensure the path correctly points to the public/assets/ folder
    ...
    const drink = {
      ...
      image: imagePath, // Ensuring correct image path
    };
  ...
  return (
    ...
    {/* </section> */}
            ...
            {/* Render DrinkModal if a drink is selected */}
            {selectedDrink && (
        <DrinkModal 
          drink={selectedDrink} 
          onClose={closeModal} 
